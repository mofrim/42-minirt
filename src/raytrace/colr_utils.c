...
/*   Updated: 2025/04/30 14:44:42 by jroseiro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_colr	colr_add_colr(t_colr c1, t_colr c2)
{
	...
	res.r = (c1.r + c2.r > 255) * 255 + (c1.r + c2.r <= 255) * (uint8_t)(c1.r
			+ c2.r);
	res.g = (c1.g + c2.g > 255) * 255 + (c1.g + c2.g <= 255) * (uint8_t)(c1.g
			+ c2.g);
	res.b = (c1.b + c2.b > 255) * 255 + (c1.b + c2.b <= 255) * (uint8_t)(c1.b
			+ c2.b);
	res.i = c1.i;
	return (res);
}
